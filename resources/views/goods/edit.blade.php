                      ...
                      <form action="/admin/goods/update" class="mws-form" method="post" enctype="multipart/form-data">
                        <div class="mws-form-inline">
                          ...
                          <div class="mws-form-row">
                                    ...
                                    <div class="mws-form-item">
                                        <input type="text" class="small" name="price" value="{{$arc->price}}">
                                    </div>
                                </div>
                                <div class="mws-form-row">
                                    <label class="mws-form-label">商品库存</label>
                                    <div class="mws-form-item">
                                        <input type="text" class="small" name="store" value="{{$arc->store}}">
                                    </div>
                                </div>
                          <div class="mws-form-row">
                            <label class="mws-form-label">商品生产厂家</label>
                            <div class="mws-form-item">
                              <input type="text" class="small" name="company" value="{{$arc->company}}">
                            </div>
                          </div>
                          <div class="mws-form-row">
                              ...
                              <select class="small"  name="catesid">
                               ...
                               <option  value="0">--请选择--</option>
                                                 @foreach($cates as $k=>$v)
                                                  <option  value="{{$v->id}}"  @if($arc->catesid == $v->id) selected @endif>{{$v->name}}</option>
                          ...
                          <div class="mws-form-row">
                            ...
                            <div class="mws-form-item">
                              <script id="editor" type="text/plain" name="descr" style="width:600px;height:500px;" >{!!$arc->descr!!}
                              </script>
                            </div>
                          </div>
                          <div class="mws-form-row">
